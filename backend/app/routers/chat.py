...
async def chat(request: ChatRequest):
    ...
    async def event_stream():
        ...
        debug_payload = {
            ...
            "query_intent": debug_info.query_intent,
            "answer_style": debug_info.answer_style,
            "query_keywords": debug_info.query_keywords,
            "query_language": debug_info.query_language,
            "corpus_languages": debug_info.corpus_languages,
            "answer_language": debug_info.answer_language,
            ...
            "context_strategy": debug_info.context_strategy,
            "context_chunks_before": debug_info.context_chunks_before,
            "context_chunks_after": debug_info.context_chunks_after,
            "context_coverage_score": debug_info.context_coverage_score,
